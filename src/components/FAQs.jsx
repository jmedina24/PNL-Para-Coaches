      ...
      <div className="faqs__container-menu">
        <div className="accordion" id="accordionExample">
          <div className="accordion-item">
            ...
            >
              <div className="accordion-body">
                No, este es un programa apto para cualquier persona
          ...
          <div className="accordion-item">
            ...
            >
              <div className="accordion-body">
                No te preocupes. Todas las clases quedan grabadas y vas a poder
                acceder a ellas siempre que lo necesites.
              </div>
            </div>
          </div>
          ...
          <div className="accordion-item">
            <h2 className="accordion-header">
              ...
              >
                ¿CUÁNDO COMIENZAN LAS CLASES Y EN QUÉ DÍA Y HORARIO SE IMPARTEN?
              </button>
            </h2>
            <div
              id="collapseFour"
            ...
            >
              <div className="accordion-body">
                <ul className="accordion-body-list">
                  ...
                  <li className="accordion-body-item">
                    El programa incluye 6 SESIONES GRUPALES EN VIVO (6 módulos).
                  </li>
                  <li className="accordion-body-item">
