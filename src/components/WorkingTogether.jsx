...
const WorkingTogether = () => {
  return (
    <div className="workingTogether__container">
      <div className="workingTogether__subContainer">
        <div className="workingTogether__container-title">
          <h3 className="workingTogether__title">
            LO QUE SUCEDE CUANDO TRABAJAMOS JUNTOS
          </h3>
        </div>
        <div id="carouselExampleIndicators" class="carousel slide">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src={Picture15} class="d-flex w-100" alt="Imagen 15" />
            </div>
